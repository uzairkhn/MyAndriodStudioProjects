package com.app.firebasedatabase;
...
import com.app.firebasedatabase.R;
import com.app.firebasedatabase.Signup;
import com.app.firebasedatabase.userdetails;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Signup.setOnClickListener(v -> {
            ...
            Intent i = new Intent(this, com.app.firebasedatabase.Signup.class);
            finish();
            startActivity(i);
        });
